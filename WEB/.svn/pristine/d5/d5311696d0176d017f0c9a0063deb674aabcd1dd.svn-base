...
<li><a href="index.php">Início</a></li>
      ...
      <div class="main-content">
		...
		<h2>Lista Veículos <a href="insert_vehicle.php"><img src="logos/plus.svg" title="Adicionar Veículo" class="imgaddd"></a></h2>
		<div class="page-title">
		</div>
		<br>
		<iframe src="vehicle_list.php" frameborder="0" width="100%" height="700px"></iframe>
      </div>
    </div>
  </body>
</html>