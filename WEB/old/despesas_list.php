...
<?php
	...
	if(isset($_GET['page']))
	{
 	...
 	$sql=mysqli_query($con, "SELECT * from despesas, veiculos, fornecedores, utilizador, tipodesp WHERE Efetuada='Sim' and despesas.codVei=veiculos.codVei AND despesas.codForn=fornecedores.CodForn and despesas.CodUser=utilizador.CodUser and despesas.CodTipoD=tipodesp.CodTipoD ORDER BY despesas.CodDesp ASC LIMIT $start, $limit") or die(mysqli_error($con));
...
<table align='center' class='table-fill'>
	...
	$rows=mysqli_num_rows(mysqli_query($con, "select * from despesas"));
