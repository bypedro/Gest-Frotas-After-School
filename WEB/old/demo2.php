...
<li><a href="demo3.php">Início</a></li>
  ...
  <p><table cellspacing='0'>
	...
	<br>
	<p align="right">
		<button class="btnnn" type=button onClick="parent.location='#.php'">Adicionar</button>
		<button class="btnn" type=button onClick="parent.location='editarperfil.php'">&#10000; Voltrar</button>
	</p>
	</div>
