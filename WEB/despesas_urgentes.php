...
$sql = "SELECT * from despesas, veiculos, fornecedores, utilizador, tipodesp WHERE data_agendada = (CURDATE() - INTERVAL 2 DAY) and Efetuada='Nao' and despesas.codVei=veiculos.codVei AND despesas.codForn=fornecedores.CodForn and despesas.CodUser=utilizador.CodUser and despesas.CodTipoD=tipodesp.CodTipoD and utilizador.CodUser=".$_SESSION['user'] . " ORDER BY Data_Efetuada DESC LIMIT 3 ";
