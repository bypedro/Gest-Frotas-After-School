...
$sql = "SELECT despesas.Data_Agendada, despesas.Valor, veiculos.Matricula, fornecedores.nome AS nomef, tipodesp.nome, DATEDIFF(CURDATE(), data_agendada) as datediff
