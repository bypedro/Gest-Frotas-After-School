...
$sql = "SELECT despesas.Data_Efetuada, despesas.Veiculo_Km, despesas.Valor, veiculos.Matricula, fornecedores.nome AS nomef, tipodesp.nome
          FROM despesas, veiculos, fornecedores, utilizador, tipodesp WHERE Efetuada='Sim' AND despesas.codVei=veiculos.codVei AND despesas.codForn=fornecedores.CodForn
