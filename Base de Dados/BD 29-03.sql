...
INSERT INTO `despesas` (`CodDesp`,`Data_Efetuada`,`Veiculo_Km`,`Valor`,`Nota`,`codVei`,`codForn`,`CodUser`,`CodTipoD`,`Data_Agendada`,`Efetuada`,`Veiculo_Km_Agendado`,`LembrarPor`) VALUES 
 (1,'2000-01-01',23,100,'TESTE',1,1,1,1,'2000-01-01','Sim',200,'KM'),
 (2,'2000-01-01',47,2,'LOL',1,1,1,2,'2000-01-01','Sim',0,'Data'),
 (3,'2000-01-01',48,5,'TESTE UPDATE',1,1,1,2,'2017-01-01','Nao',1,'KM e DATA'),
 (4,'2012-01-01',23,100,'CONCLUIR AGENDA',1,1,1,1,'2000-01-01','Sim',0,'Nada'),
 (5,'2017-03-15',29,120,'',1,1,1,3,'2000-01-01','Sim',0,'Nada'),
 (6,'2017-03-16',34,123,'TESTE',1,1,1,2,'2000-01-01','Sim',0,'Nada'),
 (7,'2017-03-16',35,1,'',1,1,1,2,'2017-01-01','Sim',0,'Nada'),
 (8,'2017-03-20',39,5,'TESTE',1,1,1,2,'2000-01-01','Sim',0,'Nada'),
 (11,'2000-01-01',0,0,'',1,1,1,1,'2017-03-20','Nao',0,'Nada'),
 (12,'2000-01-01',0,0,'',1,1,1,2,'2017-03-20','Nao',0,'Nada'),
 (13,'2000-01-01',0,0,'TESTE AGENDAR',1,1,1,3,'2017-03-20','Nao',0,'Nada'),
 (14,'2017-03-21',49,10,'Agendar Teste INSERIR',1,1,1,2,'2017-03-20','Sim',0,'KM'),
 (15,'2000-01-01',48,100,'TESTE 1',1,1,1,1,'2017-03-23','Sim',0,'DATA');
...
INSERT INTO `fornecedores` (`CodForn`,`nome`,`Rua`,`N_Telemovel`,`N_Telefone`,`site`,`email`,`CodTipoF`,`CodCi`) VALUES 
 (1,'Partex Oil and Gas Group','ZONA 1',90000000,9000000,'www.N1.com','n1serv@gmail.com',2,1);
...
INSERT INTO `manutencao` (`CodManu`,`Data_Efetuada`,`Veiculo_Km`,`Valor`,`Nota`,`CodVei`,`CodTipoM`,`CodForn`,`Data_Agendada`,`Efetuada`,`Veiculo_Km_Agendado`,`LembrarPor`,`CodUser`) VALUES 
 (1,'2000-01-01',25,2000,'Teste ',1,1,1,'2000-01-01','Sim',1,'KM',1),
 (2,'0000-00-00',30,0,'',1,1,1,'2000-01-01','Nao',10,'Data-KM',1),
 (3,'2017-03-15',0,0,'',1,1,1,'2000-01-01','Nao',0,'Nada',1),
 (4,'2017-03-15',26,10,'1',1,2,1,'2000-01-01','Nao',0,'Nada',1),
 (6,'2017-03-15',27,20,'TESTE 5',1,1,1,'2000-01-01','Nao',0,'Nada',1),
 (8,'2017-03-21',51,123,'TESTE INSERT MANU AGENDA',1,9,1,'2017-01-01','Sim',1,'KM',1),
 (11,'2017-03-15',27,12,'Test 6',1,2,1,'2000-01-01','Sim',0,'Nada',1),
 (12,'2017-03-15',28,100,'TESTE8',1,5,1,'2000-01-01','Sim',0,'Nada',1),
 (13,'2017-03-17',33,123,'',1,2,1,'2000-01-01','Sim',0,'Nada',1),
 (14,'2017-03-19',36,13,'',1,6,1,'2000-01-01','Sim',0,'Nada',1),
 (15,'2017-03-20',45,21,'',1,9,1,'2000-01-01','Sim',0,'Nada',1),
 (16,'2000-01-01',0,0,'',1,2,1,'2017-03-29','Nao',0,'Nada',1);
...
INSERT INTO `utilizador` (`CodUser`,`Nome_Registo`,`Senha`,`Nome_Proprio`,`Apelido`,`Genero`,`Data_Nascimento`,`Data_Contratacao`,`Pagamentos_Hora`,`Habilitacoes`,`Rua`,`N_Telemovel`,`N_Telefone`,`Email`,`Notas_contacto`,`Notas_Contracto`,`CodTipoU`,`CodCi`) VALUES 
 (1,'Admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918','Admin Admin','Admin Admin','Masculino','1997-02-01','1997-02-01','25','We dont Know!!\r\n\r\nTESTE','ADMIM Street',960000000,980000000,'admin@admin.com','He Likes to Sleep','He needs more money!!',1,63),
 ...
 (5,'LOL1','ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'LOL@LOL',NULL,NULL,5,NULL),
 (6,'PaUlO_Juão','2a7f7e382142a34791a7f36943247ba6dab3bf0224e05388fc607f7fdc19b48e',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PaUlO_Juão@sapo.pt',NULL,NULL,3,NULL);
...
INSERT INTO `veiabast` (`CodVeiAbast`,`Data`,`Veiculo_Km`,`Quantidade`,`Valor`,`Notas`,`CodVei`,`CodForn`,`CodUser`) VALUES 
 ...
 (3,'2000-01-01',15,1,10,'teste 3',1,1,1),
 (4,'2001-01-01',1,1,1,'teste3',1,1,1),
 (5,'2001-01-01',16,1,1,'teste3',1,1,1),
 (6,'2001-01-01',16,1,1,'teste3',1,1,1),
 (7,'2001-01-01',16,1,1,'teste3',1,1,1),
 (8,'2001-01-01',16,1,1,'teste3',1,1,1),
 (9,'2001-01-01',16,1,1,'teste3',1,1,1),
 (10,'2001-01-01',16,1,1,'teste3',1,1,1),
 (11,'2001-01-01',16,1,1,'teste3',1,1,1),
 (12,'2001-01-01',16,1,1,'teste3',1,1,1),
 (13,'2001-01-01',16,1,1,'teste3',1,1,1),
 (14,'2001-01-01',16,1,1,'teste3',1,1,1),
 (15,'2001-01-01',16,1,1,'teste3',1,1,1),
 (16,'2001-01-01',16,1,1,'teste3',1,1,1),
 (17,'2001-01-01',16,1,1,'teste3',1,1,1),
 (18,'2001-01-01',16,1,1,'teste3',1,1,1),
 (19,'2001-01-01',16,1,1,'teste3',1,1,1),
 (20,'2001-01-01',16,1,1,'teste3',1,1,1),
 (21,'2001-01-01',20,10,10,'LOL',1,1,1),
 (22,'2001-01-01',20,10,10,'LOL',1,1,1),
 (23,'2001-01-01',20,10,10,'LOL',1,1,1),
 (24,'2001-01-01',20,10,10,'LOL',1,1,1),
 (25,'2001-01-01',20,10,10,'LOL',1,1,1),
 (26,'2000-01-01',20,10,10,'LOL',1,1,1),
 (27,'2017-03-15',26,10,14,'TESTE 5',1,1,1),
 (28,'2017-03-17',32,12,16,'TESTE DATA',1,1,1),
 (29,'2017-03-19',38,15,18,'TESTE',1,1,1),
 (30,'2017-03-20',42,10,16,'TESTE',1,1,1);
...
INSERT INTO `veiacid` (`CodAcid`,`Data_Acidente`,`Notas`,`CodVei`,`CodUser`) VALUES 
 (1,'2000-01-01','DADOS SOBRE ACIDENTE Insert',1,1),
 (2,'2000-01-01','DADOS SOBRE ACIDENTE Insert',1,1),
 (3,'1999-12-12','TESTE',1,1),
 (4,'2000-01-01','DADOS SOBRE ACIDENTE Insert',1,1),
 (5,'2000-01-01','DADOS SOBRE ACIDENTE Insert',1,1);
...
INSERT INTO `veicondu` (`CodVeiC`,`Notas`,`Quando_Comecou`,`Quando_Acabou`,`CodUser`,`CodVei`,`EmUso`) VALUES 
 ...
 (3,'CARRO PAROU UPDATE','2017-03-01','2017-03-05',1,1,'Nao'),
 (4,'Novo','2017-03-05','2017-03-09',1,3,'Nao');
...
INSERT INTO `veiculos` (`codVei`,`Matricula`,`Marca`,`Modelo`,`cor`,`Ano`,`CodTipoC`,`CodTipoV`) VALUES 
 (1,'00-AA-00','BMW','M3','Austin Yellow Metallic',2014,1,1),
 (2,'00-BB-00','Nissan','Skyline','Azul',NULL,NULL,NULL),
 (3,'00-BB-00','Nissan','Skyline','Azul',2000,1,1);
