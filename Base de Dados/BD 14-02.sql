...
INSERT INTO `utilizador` (`CodUser`,`Nome_Registo`,`Senha`,`Nome_Proprio`,`Apelido`,`Genero`,`Data_Nascimento`,`Data_Contratacao`,`Pagamentos_Hora`,`Habilitacoes`,`Rua`,`N_Telemovel`,`N_Telefone`,`Email`,`Notas_contacto`,`Notas_Contracto`,`CodTipoU`,`CodCi`) VALUES 
 (1,'Admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918','','','','0000-00-00','0000-00-00','','','',0,0,'admin@admin.com','','',1,63),
...
INSERT INTO `veicondu` (`CodVeiC`,`Notas`,`Quando_Comecou`,`Quando_Acabou`,`CodUser`,`CodVei`) VALUES 
 (1,'Carro a ser Conduzido','2017-02-14','3000-00-00',1,1);
